...
export function Features() {
  return (
    <section id="features" className="py-24 md:py-32 relative">
      ...
      {/* Ambient glow */}
      <div className="absolute top-1/2 left-0 w-[400px] h-[400px] bg-primary/[0.02] rounded-full blur-[100px] pointer-events-none" />
      <div className="absolute top-1/3 right-0 w-[300px] h-[300px] bg-primary/[0.015] rounded-full blur-[80px] pointer-events-none" />
        ...
        <AnimatedSection className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {features.map((feature) => (
            <AnimatedItem key={feature.title}>
              <div className="group relative rounded-2xl border border-border/40 bg-card/50 p-6 hover:border-primary/20 transition-all duration-500 hover:shadow-lg hover:shadow-primary/[0.03] backdrop-blur-sm h-full">
                ...
                <div className="relative">
                  <div className="mb-4 flex h-11 w-11 items-center justify-center rounded-xl bg-primary/[0.08] border border-primary/15 text-primary group-hover:bg-primary/[0.12] group-hover:border-primary/25 group-hover:shadow-md group-hover:shadow-primary/10 transition-all duration-500">
